      ...
      <div className="no-print min-h-screen text-[#f4f7fb]">
        <div className="max-w-[1440px] mx-auto p-4 md:p-6 lg:p-7">
          ...
          <header className="flex flex-wrap md:flex-nowrap items-center gap-4 p-4 md:p-5 rounded-2xl bg-white/6 border border-white/14 backdrop-blur-xl shadow-2xl mb-6">
            <div className="w-14 h-14 shrink-0 rounded-xl bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center text-slate-950 font-black text-2xl shadow-lg border-2 border-amber-300">
              SSC
            </div>
                  ...
                  >
                    ...
                    >
                      <div className="relative group cursor-pointer">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-amber-500 to-amber-300 border-2 border-white shadow-xl flex items-center justify-center text-slate-950 font-black text-sm">
                          SSC
                        </div>
              ...
              <div className="flex flex-wrap items-center justify-between text-xs text-slate-400 mt-3 px-1 gap-2">
                <div className="flex items-center gap-3">
                  <span className="flex items-center gap-1.5">
                    <span className="w-3 h-3 rounded-full bg-amber-400 inline-block border border-white"></span>
              ...
              <div className="bg-white/6 border border-white/14 rounded-2xl backdrop-blur-xl p-5 shadow-2xl">
                ...
                <div className="mt-5 flex gap-3">
                  <button
                    type="button"
                    onClick={handlePrint}
                    className="flex-1 py-2.5 px-4 bg-gradient-to-r from-amber-400 to-amber-300 text-slate-950 font-bold text-sm rounded-full shadow-lg hover:shadow-amber-400/20 transition-all flex items-center justify-center gap-2 active:scale-98 cursor-pointer"
                  >
                  ...
                  <button
                    type="button"
                    onClick={handleReset}
                    className="py-2.5 px-4 bg-white/10 hover:bg-white/15 text-slate-200 border border-white/15 font-semibold text-sm rounded-full transition-all active:scale-98 cursor-pointer"
                  >
                    Reset
                  </button>
                </div>
